    ...
    <header class="site-header">
      <div class="container nav-wrap">
        <a class="brand" href="index.html" aria-label="House of Bread Ministries home">
          <img class="header-logo" src="assets/images/hob-logo-transparent.png" alt="House of Bread Ministries">
        </a>
  ...
  function footer() {
    ...
    <footer class="site-footer">
      <div class="container footer-grid">
        <div class="footer-brand-block"><a href="index.html" aria-label="${s.name} home"><img class="footer-logo" src="assets/images/hob-logo-transparent.png" alt="${s.name}"></a><p>${s.nonprofit}</p></div>
